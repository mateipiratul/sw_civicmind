...
function ComboboxTrigger({ className, children, ...props }: ComboboxPrimitive.Trigger.Props) {
  return (
    <ComboboxPrimitive.Trigger
      ...
      className={cn("[&_svg:not([class*='size-'])]:size-4", className as string | undefined)}
      {...props}
    >
      {children}
...
function ComboboxClear({ className, ...props }: ComboboxPrimitive.Clear.Props) {
  return (
    <ComboboxPrimitive.Clear
      ...
      className={cn(className as string | undefined)}
      {...props}
    >
...
function ComboboxInput({
  ...
  return (
    <InputGroup className={cn("w-auto", className as string | undefined)}>
...
function ComboboxGroup({ className, ...props }: ComboboxPrimitive.Group.Props) {
  return (
    <ComboboxPrimitive.Group data-slot="combobox-group" className={cn(className as string | undefined)} {...props} />
  );
}
...
function ComboboxLabel({ className, ...props }: ComboboxPrimitive.GroupLabel.Props) {
  return (
    <ComboboxPrimitive.GroupLabel
      ...
      className={cn("px-2 py-2 text-xs text-muted-foreground", className as string | undefined)}
      {...props}
    />
  );
}
...
function ComboboxChipsInput({ className, ...props }: ComboboxPrimitive.Input.Props) {
  return (
    <ComboboxPrimitive.Input
      ...
      className={cn("min-w-16 flex-1 outline-none", className as string | undefined)}
      {...props}
    />
  );
}
